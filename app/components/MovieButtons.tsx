...
const [open, setOpen] = useState(false)
    return(
        ...
        <PlayVideoModal state={open} changeState={setOpen} age={age} duration={duration} key={id} title={title} overview={overview} release={releaseDate} youtubeUrl={youtubeUrl} />
        </>
    )
}